<?php
// rhie/batches/upload_encounters_batch.php
...
$batchName = 'upload_encounters_batch';
...
require_once APP_ROOT . '/rhie/controllers/UploadEncounterController.php';
...
echo PHP_EOL;
echo "==================================================" . PHP_EOL;
echo "🚀 STARTING MULTI-FACILITY ENCOUNTER UPLOAD" . PHP_EOL;
echo "==================================================" . PHP_EOL;
...
foreach ($facilities as $facility) {
    ...
    try {
        ...
        */
        ...
        $controller = new UploadEncounterController(
            $model,
            $creds
        );
        ...
        */
        $sql = "SELECT DISTINCT
            ...
            WHERE em.type = 'E_TRANSFER'
            AND em.rhie_status = 1 AND up.status = 2
        ...
        */
        foreach ($rows as $r) {
            ...
            try {
                ...
                $result = $controller->uploadEncounter($r['client_id'], $r['date'], $r['encount_id'],$facilityID);
                ...
                echo json_encode([
                    ...
                    "we are in"     =>"encounter batch",
                    "type"          => $r['type'],
                    "client_id"     => $r['client_id'],
                    "date"          => $r['date'],
                    "encount_id"    => $r['encount_id'],
                    "response"      => $result
                ], JSON_PRETTY_PRINT);
                ...
                echo "Client ID: {$r['client_id']}" . PHP_EOL;
...
echo PHP_EOL;
echo "==================================================" . PHP_EOL;
echo "✅ MULTI-FACILITY ENCOUNTER UPLOAD FINISHED" . PHP_EOL;
echo "==================================================" . PHP_EOL;

<?php
// rhie/api/get_visit_encounter_api.php
...
// require_once APP_ROOT . '/link2.php';
...
$facility_id = $_GET['facility_id'] ?? $_POST['facility_id'] ?? null;
...
|--------------------------------------------------------------------------
*/
$response = $controller->fetchVisitEncounterDetails(
    $date,
    $client_id,
    $facility_id
);
